...
pca = IncrementalPCA(n_components=None, copy=False)
X_pca = pca.fit(X)
dump(X_pca, datapath/'X_SimpleImputed_StandardScaled_PolyDeg2wInteract_pca-full_20210906.joblib')
...
fig.savefig('pca_elbow_plot_20210906.png')
